...
CCNES_PREP$GroupAssignment[CCNES_PREP$GroupAssignment == "Assigned Group 3 (HC)" ] <- "Healthy"

CCNES_PREP$GroupAssignment[CCNES_PREP$GroupAssignment == "Assigned Group 2 (FSU)" ] <- "NO DBT"
CCNES_PREP$GroupAssignment[CCNES_PREP$GroupAssignment == "Assigned Group 1 (DBT)" ] <- "DBT"
...
CCNES_PREP <- CCNES_PREP[CCNES_PREP$NACheck <= 0.67 ]
