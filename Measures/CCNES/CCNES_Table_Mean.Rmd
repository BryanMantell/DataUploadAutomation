...
Old UPMC (T1, T4) name: Q10.2_1 ~ Q10.13_6
Old UPMC (T2, T3) name: Q8.2_1 ~ Q8.13_6
...
# sprintf used to format str
# I use for loop because My variable names are start from different number
...
# Edit UO CCNES Time 1 - 4 to have only CCNES questions
# FamID and Timepoint. Rename as needed, remove first two lines 
...
# Edit UPMC CCNES Time 1 - 4 to have only CCNES questions and FamID. Rename as needed
...
rm(UO_CCNES_T1, UO_CCNES_T2, UO_CCNES_T3, UO_CCNES_T4, UPMC_CCNES_T1, UPMC_CCNES_T2, UPMC_CCNES_T3, UPMC_CCNES_T4,Pedigree,Pedigree_T1,Pedigree_T2,Pedigree_T3,Pedigree_T4)
```
