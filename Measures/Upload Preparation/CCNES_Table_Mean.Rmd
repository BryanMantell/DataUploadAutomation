...
```{r Prep Sheet}
UO_CCNES <- select(UO_Qualtrics, c(Fam_ID, child_guid, child_famID, interview_date, interview_age, child_sex, GroupAssignment, Timepoint = Timepoint.x,contains("CCNES")))
UPMC_CCNES <- select(UPMC_Qualtrics, c(Fam_ID, child_guid, child_famID, interview_date, interview_age, child_sex, GroupAssignment, Timepoint = Timepoint.x,contains("CCNES")))

# Bind tw site from two site 
CCNES_Prep <- bind_rows(UO_CCNES,UPMC_CCNES)


# Clean global Environment
rm(UO_CCNES, UPMC_CCNES, UO_Qualtrics, UPMC_Qualtrics)
```
...
# TODO: Need selet subjectkey = mom_guid, src_subject_id = mother_FamID, sex = mother_sex ,interview_age, interview_date for NDA 
NDA_CCNES_Prep <- CCNES_Prep
