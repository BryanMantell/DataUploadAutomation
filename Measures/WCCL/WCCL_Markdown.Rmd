...
WCCL_DROP <- WCCL_PREP[WCCL_PREP$NACheck > 0.67, ]
WCCL_PREP67 <- WCCL_PREP[WCCL_PREP$NACheck <= 0.67, ]
WCCL_PREP100 <- WCCL_PREP[WCCL_PREP$NACheck <= 0, ]
...
NDA_WCCL_Prep <- select(WCCL_PREP67, c(subjectkey = mom_guid, src_subject_id = mother_FamID, interview_date, interview_age, sex = mother_sex , visit = timepoint, starts_with("srm")))
