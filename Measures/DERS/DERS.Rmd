...
DERS_Drop <- DERS_Prep[DERS_Prep$NACheck > 0.67, ]
DERS_Prep <- DERS_Prep[DERS_Prep$NACheck <= 0.67, ]
...
Both_site_Mean <- Progress %>%
  ...
  summarise(BothSite_DERS_Mean = mean(Row_sum,na.rm = T),n = n())
...
Mean_Table <- data.frame(UO[,c("UO_DERS")],UPMC[,"UPMC_DERS"],Both_site_Mean[,c("BothSite_DERS_Mean","n", "GroupAssignment")])
