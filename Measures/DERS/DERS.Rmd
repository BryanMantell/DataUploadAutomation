...
# Setting for knit the whole document
...
DERS_Prep <- add_column(DERS_Prep, 
               DERS_awareness_raw = rowSums(DERS_Prep[, 
...
# Calculated clarity
DERS_Prep <- add_column(DERS_Prep, 
               DERS_clarity_raw = rowSums(DERS_Prep[, 
...
# Calculated goals 
DERS_Prep <- add_column(DERS_Prep, 
               DERS_goals_raw = rowSums(DERS_Prep[, 
...
DERS_Prep <- add_column(DERS_Prep, 
               DERS_strategies_raw = rowSums(DERS_Prep[, 
...
# Calculated total 
DERS_Prep <- add_column(DERS_Prep, DERS_total_raw = rowSums(select(DERS_Prep,c(starts_with("srm"))), na.rm = T), .after = "DERS_strategies_raw")
# Mean with 67% rule ####
# Check NA percentage
