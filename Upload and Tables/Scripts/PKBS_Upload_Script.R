...
PKBS_Prep <- add_column(PKBS_Prep, pkbs_total = varScore(PKBS_Prep, c("srm_pkbs_1", "srm_pkbs_2","srm_pkbs_3","srm_pkbs_4", "srm_pkbs_5", "srm_pkbs_6","srm_pkbs_7", "srm_pkbs_8", "srm_pkbs_9", "srm_pkbs_10", "srm_pkbs_11", "srm_pkbs_12", "srm_pkbs_13","srm_pkbs_14", "srm_pkbs_15", "srm_pkbs_16", "srm_pkbs_17", "srm_pkbs_18", "srm_pkbs_19", "srm_pkbs_20","srm_pkbs_21", "srm_pkbs_22", "srm_pkbs_23", "srm_pkbs_24", "srm_pkbs_25", "srm_pkbs_26", "srm_pkbs_27", "srm_pkbs_28", "srm_pkbs_29", "srm_pkbs_30", "srm_pkbs_31", "srm_pkbs_32", "srm_pkbs_33"), Reverse = NULL, Range = NULL, Prorate = TRUE, MaxMiss = .33))
#-------------------------------------------------------------------------------------------------
...
NDA_names <- c("pkbs_social2", "pkbs_social7", "pkbs_social10", "pkbs_social12", "pkbs_social16", "pkbs_social22", "pkbs_social23", "pkbs_social25", "pkbs_social28", "pkbs_social29", "pkbs_social30", "pkbs_social32", "pkbs_social5", "pkbs_social14", "pkbs_social15", "pkbs_social17", "pkbs_social19", "pkbs_social20", "pkbs_social21", "pkbs_social24", "pkbs_social27", "pkbs_social33", "pkbs_social34", "pkbs_social1", "pkbs_social3", "pkbs_social6", "pkbs_social8", "ssis_p_soc_23_oft", "pkbs_social11", "pkbs_social13", "pkbs_social18", "pkbs_social26", "pkbs_social31")

setnames(PKBS_NDA_Prep, new_PKBS_names, NDA_names, skip_absent = FALSE)
colnames(PKBS_NDA_Prep)[40] <- "basc_social_raw"

# Round off the totals column basc_social_raw
PKBS_NDA_Prep$basc_social_raw <- round(PKBS_NDA_Prep$basc_social_raw)
